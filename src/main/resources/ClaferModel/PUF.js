scope({c0_Devices:2, c0_Enum:4, c0_FileMode:2, c0_Metric:5, c0_description:5, c0_devices:5, c0_fileMode:5});
defaultScope(1);
intRange(-8, 7);
stringLength(44);
...
c0_Hamming_Weight = Clafer("c0_Hamming_Weight").withCard(1, 1);
c0_Shannon_Entropy = Clafer("c0_Shannon_Entropy").withCard(1, 1);
c0_Min_Entropy = Clafer("c0_Min_Entropy").withCard(1, 1);
...
c0_Hamming_Weight.extending(c0_Metric);
c0_Hamming_Weight.addConstraint(equal(joinRef(join($this(), c0_description)), constant("\"Hamming Weight\"")));
c0_Hamming_Weight.addConstraint(or(equal(joinRef(join($this(), c0_fileMode)), global(c0_File)), equal(joinRef(join($this(), c0_fileMode)), global(c0_Folder))));
c0_Hamming_Weight.addConstraint(equal(joinRef(join($this(), c0_devices)), global(c0_Single)));
c0_Shannon_Entropy.extending(c0_Metric);
c0_Shannon_Entropy.addConstraint(equal(joinRef(join($this(), c0_description)), constant("\"(Shannon) Entropy\"")));
c0_Shannon_Entropy.addConstraint(or(equal(joinRef(join($this(), c0_fileMode)), global(c0_File)), equal(joinRef(join($this(), c0_fileMode)), global(c0_Folder))));
c0_Shannon_Entropy.addConstraint(equal(joinRef(join($this(), c0_devices)), global(c0_Single)));
c0_Min_Entropy.extending(c0_Metric);
c0_Min_Entropy.addConstraint(equal(joinRef(join($this(), c0_description)), constant("\"Min Entropy\"")));
c0_Min_Entropy.addConstraint(equal(joinRef(join($this(), c0_fileMode)), global(c0_Folder)));
c0_Min_Entropy.addConstraint(equal(joinRef(join($this(), c0_devices)), global(c0_Single)));
...
c0_Intra_HD.addConstraint(equal(joinRef(join($this(), c0_devices)), global(c0_Single)));
